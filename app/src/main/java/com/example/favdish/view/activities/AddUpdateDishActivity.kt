...
class AddUpdateDishActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mBinding.addDishBtn.setOnClickListener(this)
        ...
        if (p0 != null) {
            when(p0.id) {
                ...
                R.id.add_dish_btn -> {
                    ...
                    val cookingTimeMinutes = mBinding.etCookingTime.text.toString().trim() {it <=' '}
                    ...
                    when {
                        ...
                        TextUtils.isEmpty(cookingDirection) -> {
                            ...
                            Toast.makeText(
                                this@AddUpdateDishActivity,
                                "Text successfully added your favorite dish details",
                                Toast.LENGTH_SHORT
                            ).show()
        ...
        if (resultCode == Activity.RESULT_OK) {
            ...
            if (requestCode == GALLERY) {
                data?.let {
                    ...
                    /*mBinding.ivDishImage.setImageURIselectedPhotoUri)*/
                    Glide.with(this)
            ...
            Log.e("cancelled", "User cancelled image selected")
            }
        }
